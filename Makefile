...
#TODO: Fix the atevk1100_config thing...
mizar_config	:	unconfig
	@$(MKCONFIG) $(@:_config=) avr32 at32uc mizar atmel at32uc3a0xxx
...
program:
	avr32program  program -e -v -finternal@0x80000000 -O0x80000000 -cxtal u-boot
