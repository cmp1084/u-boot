...
#define SYSREG_BF(name,value) (((value) & ((1 << SYSREG_##name##_SIZE) - 1)) \
								<< SYSREG_##name##_OFFSET)
#define SYSREG_BFEXT(name,value) (((value) >> SYSREG_##name##_OFFSET) \
									& ((1 << SYSREG_##name##_SIZE) - 1))
#define SYSREG_BFINS(name,value,old) (((old) & ~(((1 << SYSREG_##name##_SIZE) - 1)	\
									<< SYSREG_##name##_OFFSET)) \
									| SYSREG_BF(name,value))

/* Register access macros */
#define sysreg_read(reg) ((unsigned long)__builtin_mfsr(SYSREG_##reg))
